  ...
  return (
    <AppShell title="Departamentos · Áreas" icon={Building2}>
      <div className="mb-4 p-3 rounded-lg border border-border bg-card text-[11px] text-muted-foreground animate-fade-up">
        ...
        Lista real de departamentos desde <code className="font-mono">isp-customer-service-api</code>.
        La modificación requiere que los endpoints de escritura estén implementados en el backend.
      </div>
