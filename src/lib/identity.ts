import type { AgentDto, AgentRole, DepartmentDto } from "@/adapters/http/dto";

export type { AgentRole };

/**
 * Sesión activa en este navegador — id = AgentDto.id real del backend, sin capa
...
export type SessionUser = {
  ...
  roleLabel: string;
  /** Ruta de aterrizaje según el rol real del agente. */
  landing: string;
};
