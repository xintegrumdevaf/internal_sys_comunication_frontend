...
const INITIAL_TEMPLATES_SEED: WhatsAppTemplate[] = [
  {
    ...
    components: {
      ...
      buttons: [{ type: "QUICK_REPLY", text: "Pagar ahora" }, { type: "QUICK_REPLY", text: "Soporte" }],
    },
  },
  {
    id: "tpl_2",
  ...
  },
  {
    ...
    components: {
      ...
      buttons: [{ type: "CALL_TO_ACTION", text: "Ver Oferta", ctaType: "URL", url: "https://netops.io/promo" }],
    },
  },
];
